...
<template>
  ...
  >
    <header class="mx-auto w-full max-w-344 shrink-0 px-4 pt-5 pb-4 lg:px-8" :class="{ 'max-lg:hidden': fullscreen }">
    ...
    <main
      class="mx-auto"
      :class="fullscreen ? 'max-w-none flex-1 min-h-0 px-0' : 'max-w-344 px-4 lg:px-8'"
    >
      <slot />
    </main>
